                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            <i className="ri-mail-send-fill contact__card-icon"></i>

                            <h3 className="contact__card-title">Email</h3>
                            <span className="contact__card-data">user@gmail.com</span>

                            <a href="mailto:examplemail@gmail.com.com" className="contact__button">Write me
                                <i className="ri-arrow-right-fill contact__button-icon"></i>
                            </a>
                        </div>


                        <div className="contact__card">
                            <i className="ri-whatsapp-fill contact__card-icon"></i>
